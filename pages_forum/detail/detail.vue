		...
		<view class="container">
				...
				<view v-else>
					...
					<view class="userinfo">
						<view class="avatar">
							<image 
							 :src="giveDefaultAvatar(detailObj)"
						...
						<view class="text">
							...
							<view class="small">
								<uni-dateformat :date="detailObj.publish_date" format="yyyy年MM月dd日 hh:mm"></uni-dateformat>
								<text class="IP">IP属地：{{detailObj.province}}</text>
							</view>
						</view>
					</view>
					<view class="content">
